...
import { scrollPos, startScroll, stopScroll, update } from "../../app";
const lang = {
  Html: "bxl-html5",
  Css: "bxl-css3",
    ...
    fetch("/content.json")
      ...
      .then((text) => {
        ...
        setTimeout(() => {
          ...
          stopScroll()
          document.querySelector(".project .blackout").style.display = "block";
          document.querySelector(".project .item-display").style.display = "block";
          if(window.innerWidth<600){
          }
          else if(document.querySelector(".project").getBoundingClientRect().top>0){
              document.querySelector(".project .blackout").style.top = `-${document.querySelector(".project").getBoundingClientRect().top}px`;
              document.querySelector(".project .item-display").style.top = `-${document.querySelector(".project").getBoundingClientRect().top}px`;
          }else{
              document.querySelector(".project .blackout").style.top = `${Math.abs(document.querySelector(".project").getBoundingClientRect().top)}px`;
              document.querySelector(".project .item-display").style.top = `${Math.abs(document.querySelector(".project").getBoundingClientRect().top)}px`;
            }
      });
  }
  useEffect(() => {
    ...
    function loader() {
      // keys of project that has to be loaded
      let list = ["web-000", "web-003", "flu-001", "web-002", "fla-000"];
      fetch("/content.json")
        .then((response) => response.json())
        .then((text) => {
          setItem((prev) => []);
  ...
  return (
    <section className="project" data-scroll-section>
      ...
      <div className="link">
        ...
        <p style={{ display: filter ? "block" : "none" }}>All</p>
      ...
      <div className="display" id="display">
        ...
        {/* <div className="item">
                ...
                <div className="bottom">
                    ...
                    <div className="tech">
                        <p><i class='bx bxl-html5' ></i><span>HTML</span></p>
                        <p><i class='bx bxl-css3' ></i><span>CSS</span></p>
                    </div>
                </div>
            </div> */}
      </div>
